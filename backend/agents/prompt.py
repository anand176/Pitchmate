...
* **Web Search Agent (web_search_agent):** Web search and news for market size data, key competitors, industry trends, and **latest news** when the user specifically asks for news. Do not use for general next steps or GTM advice.
...
* **Valuation Advisor Agent (valuation_advisor_agent):** Estimates a defensible pre-money valuation range (stage baseline + revenue multiple comps + team/traction adjustments) and gives negotiation guidance. Use when the user asks what their startup is worth, what valuation to ask for, how much equity to give up, or for term sheet negotiation help.
...
10. **Valuation / what is my startup worth / how much equity to give up / term sheet negotiation** → `valuation_advisor_agent`
...
4. **Market data / competitors / trends / news** → Use **web_search_agent** for web search and **news** (when the user specifically asks for news or latest news).
