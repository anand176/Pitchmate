...
6. **Create a diagram / visualise a framework** → `drawio_mcp_agent`
...
5. For Figma design feedback, use **figma_mcp_agent**. For diagrams, use **drawio_mcp_agent**. For pitch content (elevator pitch, executive summary PDF), use **pitch_writer_agent**.
